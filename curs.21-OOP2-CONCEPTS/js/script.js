...
//a static property is called on the class/constructor function itself, NOT on the instance/object
...
//puffy.SIT// puffy.SET is not a function///

console.log("OBJECT CREATION METHODS");
var a = { x:2 };
var b = {x: 2};
console.log("a===b", a===b); //false
//a and b two different object (not primitives) that happen to have the same value

var n = 2,
    m =2;
console.log("n===m", n === m); //true, because numbers
